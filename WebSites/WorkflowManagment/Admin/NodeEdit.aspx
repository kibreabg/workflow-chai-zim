                            ...
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    <asp:TextBox ID="txtTitle" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                                        ...
                                        CssClass="validator" ControlToValidate="txtTitle" EnableClientScript="False"></asp:RequiredFieldValidator></label>
                            </section>
                        </div>
                        <div class="row">
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    <asp:TextBox ID="txtDescription" runat="server"></asp:TextBox></label>
                            </section>
                        </div>
                        <div class="row">
                            <section class="col col-6">
                            ...
                            <asp:ImageButton ID="imbMoveup" runat="server"
                                OnClick="imbMoveup_Click" ToolTip="Move Up" />
                        </div>
                        <div class="row">
                            <section class="col col-6">
                                <label class="label">Image Path</label>
                                <label class="input">
                                    <asp:TextBox ID="txtImagePath" runat="server"></asp:TextBox></label>
                            </section>
                        </div>
                    </fieldset>
                    <h4>Authorization</h4>
