<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCabsReport.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Report.Views.frmCabsReport"
...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="White" Visible="false">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
            <LocalReport ReportPath="Report\CABReport.rdlc">
                <DataSources>
