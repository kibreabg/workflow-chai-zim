...
{
    public partial class frmCabsReport : POCBasePage, IfrmCabsReportView
	{
		private frmCabsReportPresenter _presenter;
		...
		[CreateNew]
        public frmCabsReportPresenter Presenter
		{
			get
			{
        ...
        private void ViewCabsReport()
        {

            var path = Server.MapPath("TravelAdvanceReport.rdlc");
            var datasource = _presenter.GetCabsReport(txtDateFrom.Text, txtDateTo.Text);
