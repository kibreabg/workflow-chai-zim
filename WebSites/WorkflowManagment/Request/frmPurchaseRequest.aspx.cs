...
namespace Chai.WorkflowManagment.Modules.Request.Views
{
    public partial class frmPurchaseRequest : POCBasePage, IPurchaseRequestView
    {
        ...
        {
            get { return "{334AAED8-456F-44AC-A203-FC4CE87FC3CD}"; }
        }
        ...
        private void CheckApprovalSettings()
        {
            if (
                _presenter.GetApprovalSetting(
                    RequestType.Purchase_Request.ToString().Replace('_', ' '),
                    0
                ) == null
            )
            {
        ...
        private string AutoNumber()
        {
            ...
            return "PR" + _presenter.CurrentUser().Id.ToString() + "-" + timestamp;
        }
        ...
        private void BindPurchaseRequest()
        {
            if (_presenter.CurrentPurchaseRequest.Id > 0)
            {
                ...
                txtRequestDate.Text =
                    _presenter.CurrentPurchaseRequest.RequestedDate.ToShortDateString();
                ...
                txtdeliveryDate.Text =
                    _presenter.CurrentPurchaseRequest.Requireddateofdelivery.ToShortDateString();
                txtSuggestedSupplier.Text =
                    _presenter.CurrentPurchaseRequest.SuggestedSupplier.ToString();
        ...
        private void SavePurchaseRequest()
        {
            ...
            try
            {
                ...
                _presenter.CurrentPurchaseRequest.RequestedDate = Convert.ToDateTime(
                    txtRequestDate.Text
                );
                ...
                _presenter.CurrentPurchaseRequest.Requireddateofdelivery = Convert.ToDateTime(
                    txtdeliveryDate.Text
                );
                ...
                {
                    foreach (
                        PurchaseRequestDetail detail in _presenter
        ...
        private void SavePurchaseRequestStatus()
        {
            ...
            {
                if (
                    _presenter.GetApprovalSettingforPurchaseProcess(
                        RequestType.Purchase_Request.ToString().Replace('_', ' '),
                        0
                    ) != null
                )
                {
                    int i = 1;
                    foreach (
                        ApprovalLevel AL in _presenter
                            .GetApprovalSettingforPurchaseProcess(
                                RequestType.Purchase_Request.ToString().Replace('_', ' '),
                                0
                            )
                            .ApprovalLevels
        ...
        {
            foreach (
                PurchaseRequestStatus PRS in _presenter
                    .CurrentPurchaseRequest
            ...
            )
            {
                if (PRS.ApprovalStatus == null)
                {
                    ...
                    _presenter.CurrentPurchaseRequest.ProgressStatus =
        ...
        private void SendEmail(PurchaseRequestStatus PRS)
        {
            ...
            {
                EmailSender.Send(
                    _presenter.GetSuperviser(PRS.Approver).Email,
                    "Purchase Request",
                    _presenter.GetUser(_presenter.CurrentPurchaseRequest.Requester).FullName
                        + "' Request for Item procurment No. '"
                        + _presenter.CurrentPurchaseRequest.RequestNo
                        + "'"
                );
            }
            else
            {
                EmailSender.Send(
                    _presenter
                        .GetSuperviser(
                            _presenter.GetAssignedJobbycurrentuser(PRS.Approver).AssignedTo
                        )
                        .Email,
                    "Purchase Request",
                    _presenter.GetUser(_presenter.CurrentPurchaseRequest.Requester).FullName
        ...
        {
            _presenter.DeletePurchaseRequest(
                _presenter.GetPurchaseRequestById(
                    Convert.ToInt32(grvPurchaseRequestList.DataKeys[e.RowIndex].Value)
                )
            );

            btnFind_Click(sender, e);
            Master.ShowMessage(
                new AppMessage("Purchase Request Successfully Deleted", RMessageType.Info)
            );
        }

        protected void grvPurchaseRequestList_RowDataBound(
            object sender,
            GridViewRowEventArgs e
        )
        { }

        protected void grvPurchaseRequestList_PageIndexChanging(
            object sender,
        ...
        {
            grvPurchaseRequestList.DataSource = _presenter.ListPurchaseRequests(
                txtRequestNosearch.Text,
                txtRequestDatesearch.Text
            );
        ...
        {
            dgPurchaseRequestDetail.DataSource = _presenter
                .CurrentPurchaseRequest
                .PurchaseRequestDetails;
            dgPurchaseRequestDetail.DataBind();
        }

        protected void dgPurchaseRequestDetail_CancelCommand(
            object source,
        ...
        protected void dgPurchaseRequestDetail_DeleteCommand(
            object source,
            DataGridCommandEventArgs e
        )
        {
            ...
            if (PRDId > 0)
                ...
                prd = (PurchaseRequestDetail)
                    _presenter.CurrentPurchaseRequest.PurchaseRequestDetails[e.Item.ItemIndex];
            try
            {
                if (PRDId > 0)
                {
                    ...
                    _presenter.CurrentPurchaseRequest.TotalPrice =
                        _presenter.CurrentPurchaseRequest.TotalPrice - prd.EstimatedCost;
                    txtTotal.Text = (_presenter.CurrentPurchaseRequest.TotalPrice).ToString();
                ...
                Master.ShowMessage(
                    new AppMessage(
                        "Purchase Request Detail was Removed Successfully",
                        RMessageType.Info
                    )
                );
            }
            catch (Exception ex)
            {
                Master.ShowMessage(
                    new AppMessage(
                        "Error: Unable to delete Purchase Request Detail. " + ex.Message,
                        RMessageType.Error
                    )
                );
                ExceptionUtility.LogException(ex, ex.Source);
        ...
        protected void dgPurchaseRequestDetail_EditCommand(
            object source,
            DataGridCommandEventArgs e
        )
        {
        ...
        protected void dgPurchaseRequestDetail_ItemCommand(
            object source,
            DataGridCommandEventArgs e
        )
        {
            if (e.CommandName == "AddNew")
            {
                try
                {
                    if (_presenter.CurrentPurchaseRequest.PurchaseRequestDetails.Count() < 1)
                    {
                        ...
                        DropDownList ddlFAccount =
                            e.Item.FindControl("ddlFAccount") as DropDownList;
                        Detail.ItemAccount = _presenter.GetItemAccount(
                            int.Parse(ddlFAccount.SelectedValue)
                        );
                        ...
                        TextBox txtFPriceperunit =
                            e.Item.FindControl("txtFPriceperunit") as TextBox;
                        Detail.Priceperunit = Convert.ToDecimal(txtFPriceperunit.Text);
                        Detail.EstimatedCost =
                            Convert.ToInt32(txtFQty.Text)
                            * Convert.ToDecimal(txtFPriceperunit.Text);
                        //Determine total cost
                        decimal cost = 0;
                        if (_presenter.CurrentPurchaseRequest.PurchaseRequestDetails.Count > 0)
                        {
                        ...
                        //Determine total cost end
                        _presenter.CurrentPurchaseRequest.TotalPrice =
                            _presenter.CurrentPurchaseRequest.TotalPrice + Detail.EstimatedCost;
                        txtTotal.Text = (_presenter.CurrentPurchaseRequest.TotalPrice).ToString();
                        ...
                        Master.ShowMessage(
                            new AppMessage(
                                "Purchase Request Detail added successfully.",
                                RMessageType.Info
                            )
                        );
                    ...
                    else
                    {
                        Master.ShowMessage(
                            new AppMessage(
                                "You can only request ONE Item per request!",
                                RMessageType.Error
                            )
                        );
                    }
                ...
                catch (Exception ex)
                {
                    Master.ShowMessage(
                        new AppMessage(
                            "Error: Unable to Add Purchase Request Detail. " + ex.Message,
                            RMessageType.Error
                        )
                    );
                    ExceptionUtility.LogException(ex, ex.Source);
        ...
        protected void dgPurchaseRequestDetail_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var cvCbEdtGrant =
                        e.Item.FindControl("CustomValidatorCbEdtGrant") as CustomValidator;
                    if (cvCbEdtGrant != null)
                    {
                        cvCbEdtGrant.Attributes["data-rowindex"] = e.Item.ItemIndex.ToString();
                    }
                    var cvCbEdtProject =
                        e.Item.FindControl("CustomValidatorCbEdtProject") as CustomValidator;
                    ...
                    if (ddlItemAccount != null)
                    {
                        ...
                        if (
                            _presenter
                                .CurrentPurchaseRequest
                                .PurchaseRequestDetails[e.Item.DataSetIndex]
                                .ItemAccount != null
                        )
                        {
                            ListItem liI = ddlItemAccount.Items.FindByValue(
                                _presenter
                                    .CurrentPurchaseRequest.PurchaseRequestDetails[
                                        e.Item.DataSetIndex
                                    ]
                    ...
                    if (cbEdtProject != null)
                    {
                        ...
                        if (projectId != 0)
                        {
                            ...
                            ListItem liProject = cbEdtProject.Items.FindByValue(
                                projectId.ToString()
                            );
                            if (liProject != null)
                            {
        ...
        protected void dgPurchaseRequestDetail_UpdateCommand(
            object source,
            DataGridCommandEventArgs e
        )
        {
            ...
            try
            {
                ...
                Detail.EstimatedCost =
                    Convert.ToInt32(txtQty.Text) * Convert.ToDecimal(txtPriceperunit.Text);
                //Determine total cost
                decimal cost = 0;
                if (_presenter.CurrentPurchaseRequest.PurchaseRequestDetails.Count > 0)
                {
                ...
                Master.ShowMessage(
                    new AppMessage(
                        "Purchase Request Detail  Updated successfully.",
                        RMessageType.Info
                    )
                );
                dgPurchaseRequestDetail.EditItemIndex = -1;
            ...
            catch (Exception ex)
            {
                Master.ShowMessage(
                    new AppMessage(
                        "Error: Unable to Update Purchase Request Detail. " + ex.Message,
                        RMessageType.Error
                    )
                );
                ExceptionUtility.LogException(ex, ex.Source);
        ...
        protected void btnRequest_Click(object sender, EventArgs e)
        {
            ...
            if (_presenter.CurrentPurchaseRequest.PurchaseRequestDetails.Count != 0)
            {
                if (_presenter.CurrentPurchaseRequest.PurchaseRequestStatuses.Count != 0)
                {
                    ...
                    Master.ShowMessage(
                        new AppMessage(
                            "Successfully did a Purchase Request, Reference No - <b>'"
                                + _presenter.CurrentPurchaseRequest.RequestNo
                                + "'</b> ",
                            RMessageType.Info
                        )
                    ...
                    Log.Info(
                        _presenter.CurrentUser().FullName
                            + " has requested for a Purchase of Total Price "
                            + _presenter.CurrentPurchaseRequest.TotalPrice
                    );
                ...
                else
                {
                    Master.ShowMessage(
                        new AppMessage(
                            "There was an error while constructing the Approval Process",
                            RMessageType.Error
                        )
                    );
                }
            ...
            else
            {
                Master.ShowMessage(
                    new AppMessage(
                        "You have to insert at least one purchase item detail",
                        RMessageType.Error
                    )
                );
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (_presenter.CurrentPurchaseRequest.CurrentStatus == null)
                {
                    ...
                    Master.ShowMessage(
                        new AppMessage("Purchase Request Deleted ", RMessageType.Info)
                    );
                    BindSearchPurchaseRequestGrid();
                }
                else
                    Master.ShowMessage(
                        new AppMessage(
                            "Warning: Unable to Delete Purchase Request ",
                            RMessageType.Error
                        )
                    );
            }
            catch (Exception ex)
            {
                Master.ShowMessage(
                    new AppMessage(
                        "Warning: Unable to Delete Purchase Request " + ex.Message,
                        RMessageType.Error
                    )
                );
                ExceptionUtility.LogException(ex, ex.Source);
        ...
        private void UploadFile()
        {
            ...
            if (fileName != String.Empty)
            {
                ...
                Master.ShowMessage(
                    new AppMessage("Successfully Uploaded the Attachment!", RMessageType.Info)
                );
            }
            else
            {
