...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" runat="Server">
	...
	<script type="text/javascript">
		function validateCbProject(sender, args) {
			var hiddenField = document.getElementById('DefaultContent_dgOperationalControlDetail_CbProject_CbProject_HiddenField');
		...
		function validateCbEdtProject(sender, args) {
			...
			if (rowIndex) {
				var idGuess = 'DefaultContent_dgOperationalControlDetail_CbEdtProject_' + rowIndex + '_CbEdtProject_HiddenField_' + rowIndex;
				hiddenField = document.getElementById(idGuess);
			}
			args.IsValid = hiddenField && hiddenField.value !== "0" && hiddenField.value !== "";
		}
		function validateCbGrant(sender, args) {
			var hiddenField = document.getElementById('DefaultContent_dgOperationalControlDetail_CbGrant_CbGrant_HiddenField');
			args.IsValid = hiddenField && hiddenField.value !== "0" && hiddenField.value !== "";
		}
		function validateCbEdtGrant(sender, args) {
			...
			var hiddenField = null;
			if (rowIndex) {
				var idGuess = 'DefaultContent_dgOperationalControlDetail_CbEdtGrant_' + rowIndex + '_CbEdtGrant_HiddenField_' + rowIndex;
				hiddenField = document.getElementById(idGuess);
			}
			args.IsValid = hiddenField && hiddenField.value !== "0" && hiddenField.value !== "";
		}
											...
											<asp:DataGrid ID="dgOperationalControlDetail" runat="server" AutoGenerateColumns="false"
												...
												<Columns>
													...
													<asp:TemplateColumn HeaderText="Amount">
														...
														<EditItemTemplate>
															<asp:TextBox ID="txtEdtAmount" runat="server"
																CssClass="form-control" Text='<%# DataBinder.Eval(Container.DataItem, "Amount")%>'></asp:TextBox>
															<cc1:FilteredTextBoxExtender ID="txtEdtAmount_FilteredTextBoxExtender" runat="server"
																Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtEdtAmount"
																ValidChars="&quot;.&quot;"></cc1:FilteredTextBoxExtender>
															<asp:RequiredFieldValidator ID="rfvtxtEdtAmount" runat="server" ControlToValidate="txtEdtAmount"
																CssClass="validator" Display="Dynamic" ErrorMessage="Amount is required"
														...
														<FooterTemplate>
															...
															<cc1:FilteredTextBoxExtender ID="txtAmount_FilteredTextBoxExtender" runat="server"
																Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtAmount"
																ValidChars="&quot;.&quot;"></cc1:FilteredTextBoxExtender>
															<asp:RequiredFieldValidator ID="rfvtxtAmount" runat="server"
																ControlToValidate="txtAmount" CssClass="validator" Display="Dynamic"
																ErrorMessage="Amount is required" SetFocusOnError="true" ValidationGroup="save"></asp:RequiredFieldValidator>
														</FooterTemplate>
													</asp:TemplateColumn>
