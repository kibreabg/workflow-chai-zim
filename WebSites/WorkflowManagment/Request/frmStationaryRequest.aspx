<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="frmStationaryRequest.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Request.Views.frmStationaryRequest" %>
                    ...
                    <fieldset>
                        ...
                        <div class="tab-pane active" id="hr2">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#iss1" data-toggle="tab">Stationary Request Detail</a>
                                </li>
                            </ul>
                            <div class="tab-content padding-10">
                                <div class="tab-pane active" id="iss1">
                                    <asp:DataGrid ID="dgStationaryRequestDetail" runat="server" AlternatingRowStyle-CssClass="" AutoGenerateColumns="False" CellPadding="0"
                                        CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="paginate_button active" DataKeyField="Id"
                                        GridLines="None"
                                        OnCancelCommand="dgStationaryRequestDetail_CancelCommand" OnDeleteCommand="dgStationaryRequestDetail_DeleteCommand" OnEditCommand="dgStationaryRequestDetail_EditCommand"
                                        OnItemCommand="dgStationaryRequestDetail_ItemCommand" OnItemDataBound="dgStationaryRequestDetail_ItemDataBound" OnUpdateCommand="dgStationaryRequestDetail_UpdateCommand"
                                        ShowFooter="True">
            ...
            <div class="modal-content">
                <div class="modal-body no-padding">
                    <div class="jarviswidget" data-widget-colorbutton="false"
                        ...
                        <header>
                            <span class="widget-icon"><i class="fa fa-edit"></i></span>
                            <h2>Search Stationary Request</h2>
                        </header>
                        <div>
                        ...
                        <asp:GridView ID="grvStationaryRequestList"
                            runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                            OnRowDataBound="grvStationaryRequestList_RowDataBound" OnRowDeleting="grvStationaryRequestList_RowDeleting"
                            OnSelectedIndexChanged="grvStationaryRequestList_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="grvStationaryRequestList_PageIndexChanging"
