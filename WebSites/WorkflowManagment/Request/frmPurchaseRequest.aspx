                        ...
                        <div class="row">
                            ...
                            <section class="col col-4">
                                ...
                                <label class="input">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvTxtComment" CssClass="validator" runat="server" ControlToValidate="txtComment" ErrorMessage="Purpose of Request is Required" InitialValue="" SetFocusOnError="True" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </label>
                            </section>
                            <section class="col col-4">
