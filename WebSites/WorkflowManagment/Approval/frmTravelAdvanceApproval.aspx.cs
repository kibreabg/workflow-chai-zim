...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmTravelAdvanceApproval : POCBasePage, ITravelAdvanceApprovalView
    {
        ...
        {
            if (_presenter.CurrentTravelAdvanceRequest.TravelAdvanceRequestStatuses.Count == _presenter.CurrentTravelAdvanceRequest.CurrentLevel && (_presenter.CurrentUser().EmployeePosition.PositionName == "Analyst, Finance"))
            {
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            {
                Master.ShowMessage(new AppMessage("Error: While Approving Travel Advance!", RMessageType.Error));
