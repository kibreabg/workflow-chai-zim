...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmTravelAdvanceApproval : POCBasePage, ITravelAdvanceApprovalView
    {
        ...
        {
            if (_presenter.CurrentTravelAdvanceRequest.TravelAdvanceRequestStatuses.Count == _presenter.CurrentTravelAdvanceRequest.CurrentLevel && (_presenter.CurrentUser().EmployeePosition.PositionName == "Analyst, Finance " || _presenter.GetUser(_presenter.CurrentTravelAdvanceRequest.CurrentApprover).IsAssignedJob == true))
            {
        ...
        private void SendEmailToRequester()
        {
            if (_presenter.CurrentTravelAdvanceRequest.CurrentStatus != ApprovalStatus.Rejected.ToString())
                EmailSender.Send(_presenter.GetUser(_presenter.CurrentTravelAdvanceRequest.AppUser.Id).Email, "Travel Advance Completion", "Your Travel Advance Request with Travel Advance No. - '" + (_presenter.CurrentTravelAdvanceRequest.TravelAdvanceNo).ToUpper() + "' was Completed. Your funds are being processed.");
        }
