<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="frmFuelCardApproval.aspx.cs" Inherits="Chai.WorkflowManagment.Modules.Approval.Views.frmFuelCardApproval" %>
        ...
        <fieldset>
            ...
            <table style="width: 75%;">
                ...
                <tr>
                    ...
                    <td style="width: 25%;">
                        <asp:Label ID="lblPaymentMethRes" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 25%;">
                        <strong>
