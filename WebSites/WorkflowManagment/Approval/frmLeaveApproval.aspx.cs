...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmLeaveApproval : POCBasePage, ILeaveApprovalView
    {
        ...
        private void SendEmail(LeaveRequestStatus LRS)
        {
            ...
            {
                EmailSender.Send(_presenter.GetUser(LRS.Approver).Email, "Leave Request", "'" + _presenter.GetUser(_presenter.CurrentLeaveRequest.Requester).FullName + "' Requests for Leave ");
            }
            else
            {
                EmailSender.Send(_presenter.GetUser(_presenter.GetAssignedJobbycurrentuser(LRS.Approver).AssignedTo).Email, "Leave Request", "'" + _presenter.GetUser(_presenter.CurrentLeaveRequest.Requester).FullName + "' Requests for Leave");
            }
        ...
        {
            EmailSender.Send(_presenter.GetUser(_presenter.CurrentLeaveRequest.Requester).Email, "Leave Request ", "'" + "' Your Leave Request for '" + _presenter.CurrentLeaveRequest.RequestNo + "' was Completed.");
        }
