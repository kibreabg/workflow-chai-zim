...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmOperationalControlApproval : POCBasePage, IOperationalControlApprovalView
    {
        ...
        private void SendEmail(OperationalControlRequestStatus OCRS)
        {
            ...
            {
                EmailSender.Send(_presenter.GetUser(OCRS.Approver).Email, "Bank Payment Approval", "'" + _presenter.CurrentOperationalControlRequest.AppUser.FullName + "' Requests for payment");
            }
            else
            {
                EmailSender.Send(_presenter.GetUser(_presenter.GetAssignedJobbycurrentuser(OCRS.Approver).AssignedTo).Email, "Bank Payment Approval", _presenter.CurrentOperationalControlRequest.AppUser.FullName + "' Requests for payment");
            }
