					...
					<fieldset>
						<div class="row">
							<section class="col col-3">
								<asp:Label ID="lblTravelAdvNo" runat="server" Text="Travel Advance No" CssClass="label"></asp:Label>
								<label class="input">
									<asp:TextBox ID="txtSrchTravelAdvNo" runat="server" Visible="true"></asp:TextBox>
								</label>
							</section>
							<section class="col col-3">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;</button>
					<h4 class="modal-title">Process Expense Liquidation Request</h4>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;</button>
					<h4 class="modal-title">Expense Liquidation Details</h4>
				</div>
				<div class="modal-body">
					<div class="jarviswidget-editbox"></div>
					<div class="widget-body no-padding">
							...
							<asp:UpdatePanel ID="upLiquidationDetail" runat="server">
								<ContentTemplate>
									<asp:DataGrid ID="dgLiquidationRequestDetail" runat="server"
										...
										OnEditCommand="dgLiquidationRequestDetail_EditCommand" OnUpdateCommand="dgLiquidationRequestDetail_UpdateCommand">
										<Columns>
