...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmPaymentReimbursementApproval : POCBasePage, IPaymentReimbursementApprovalView
    {
        ...
        private void SendEmail(PaymentReimbursementRequestStatus PRRS)
        {
            ...
            {
                EmailSender.Send(_presenter.GetUser(PRRS.Approver).Email, "Payment Reimbursement Request", _presenter.CurrentPaymentReimbursementRequest.CashPaymentRequest.AppUser.FullName + "' Request for Payment Reimbursement");
            }
            else
            {
                EmailSender.Send(_presenter.GetUser(_presenter.GetAssignedJobbycurrentuser(PRRS.Approver).AssignedTo).Email, "Payment Reimbursement Request", _presenter.CurrentPaymentReimbursementRequest.CashPaymentRequest.AppUser.FullName + "' Request for Payment Reimbursement");
            }
