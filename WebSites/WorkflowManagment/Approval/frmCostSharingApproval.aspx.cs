...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmCostSharingApproval : POCBasePage, ICostSharingApprovalView
    {
        ...
        {
            if (_presenter.CurrentCostSharingRequest.CostSharingRequestStatuses.Count == _presenter.CurrentCostSharingRequest.CurrentLevel && (_presenter.CurrentUser().EmployeePosition.PositionName == "Analyst, Finance"))
            {
