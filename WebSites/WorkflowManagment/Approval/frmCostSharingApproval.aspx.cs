...
namespace Chai.WorkflowManagment.Modules.Approval.Views
{
    public partial class frmCostSharingApproval : POCBasePage, ICostSharingApprovalView
    {
        ...
        {
            EmailSender.Send(_presenter.GetUser(_presenter.CurrentCostSharingRequest.AppUser.Id).Email, "Payment Request", "'" + "' Your Payment Request was Rejected for  reason '" + CPRS.RejectedReason + "'");
        }
