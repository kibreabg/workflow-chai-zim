...
{
    public class frmCabsReportPresenter : Presenter<IfrmCabsReportView>
    {
        ...
        public frmCabsReportPresenter([CreateNew] Chai.WorkflowManagment.Modules.Report.ReportController controller)
        {
        ...
        {
            return _controller.GetCabsReport(DateFrom, DateTo);
        }
