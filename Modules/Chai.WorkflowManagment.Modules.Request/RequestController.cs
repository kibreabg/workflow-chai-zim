...
namespace Chai.WorkflowManagment.Modules.Request
{
    public class RequestController : ControllerBase
    {
        ...
        {
            return _workspace
                .SqlQuery<AppUser>("SELECT * FROM AppUsers WHERE EmployeePosition_Id = " + position)
                .ToList()
                .Last<AppUser>();
        }
        ...
        public IList<TravelLog> ListTravelLogs(int RequestId)
        {
            ...
            filterExpression =
                "SELECT * FROM TravelLogs Where 1 = Case when '"
                + RequestId
                + "' = '' Then 1 When TravelLogs.VehicleRequest_Id = '"
                + RequestId
                + "' Then 1 END ";
        ...
        public IList<VehicleRequest> ListVehicleRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT * FROM VehicleRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And VehicleRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM CashPaymentRequests LEFT JOIN Suppliers on CashPaymentRequests.Supplier_Id = Suppliers.Id Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And CashPaymentRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        public IList<CashPaymentRequest> ListCashPaymentsNotExpensed()
        {
            ...
            return WorkspaceFactory
                ...
                .Query<CashPaymentRequest>(x =>
                    x.PaymentReimbursementStatus == "Completed"
                    && x.PaymentReimbursementRequest == null
                    && currentUserId == x.AppUser.Id
                )
                .ToList();
        }
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM CostSharingRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And CostSharingRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        public IList<CostSharingRequest> ListCostSharingRequestsNotExpensed()
        {
            ...
            return WorkspaceFactory
                ...
                .Query<CostSharingRequest>(x =>
                    x.PaymentReimbursementStatus == "Completed" && currentUserId == x.AppUser.Id
                )
                .ToList();
        }
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM PaymentReimbursementRequests Where 1 = Case when '"
                + RequestDate
                + "' = '' Then 1 When PaymentReimbursementRequests.RequestDate = '"
                + RequestDate
                + "'  Then 1 END ORDER BY PaymentReimbursementRequests.Id Desc ";
        ...
        public IList<PaymentReimbursementRequest> GetPaymentReimbursementRequests()
        {
            return WorkspaceFactory
                .CreateReadOnly()
                .Query<PaymentReimbursementRequest>(null)
                .ToList();
        }
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM BankPaymentRequests Where 1 = Case when '"
                + RequestNo
                ...
                + ProcessDate
                + "'  Then 1 END ORDER BY BankPaymentRequests.Id Desc";
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM OperationalControlRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END ORDER BY OperationalControlRequests.Id Desc";
        ...
        public IList<OperationalControlRequest> GetOperationalControlRequests()
        {
            return WorkspaceFactory
                .CreateReadOnly()
                .Query<OperationalControlRequest>(null)
                .ToList();
        }
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM TravelAdvanceRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And TravelAdvanceRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM ExpenseLiquidationRequests INNER JOIN TravelAdvanceRequests ON TravelAdvanceRequests.Id = ExpenseLiquidationRequests.Id Where 1 = Case when '"
                + ExpenseType
                + "' = '' Then 1 When ExpenseLiquidationRequests.ExpenseType = '"
                + ExpenseType
                + "' Then 1 END And  1 = Case when '"
                + RequestDate
        ...
        public IList<ExpenseLiquidationRequest> GetExpenseLiquidationRequests()
        {
            return WorkspaceFactory
                .CreateReadOnly()
                .Query<ExpenseLiquidationRequest>(null)
                .ToList();
        }
        ...
        public IList<LeaveRequest> GetAnnualLeaveRequestsByRequester(int requesterId)
        {
            return WorkspaceFactory
                ...
                .Query<LeaveRequest>(x =>
                    x.Requester == requesterId
                    && x.LeaveType.LeaveTypeName.Contains("Annual")
                    && x.RequestedDate.Year == DateTime.Today.Year
                    && x.CurrentStatus == "Issued"
                )
                .ToList();
        }
        ...
        public IList<LeaveRequest> ListLeaveRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT  *  FROM LeaveRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And LeaveRequests.Requester='"
                + GetCurrentUser().Id
        ...
        public IList<PurchaseRequest> GetPurchaseReqsByCurUser()
        {
            ...
            return WorkspaceFactory
                .CreateReadOnly()
                .Query<PurchaseRequest>(x => x.ProgressStatus == "Completed")
                .ToList();
        }
        ...
        public IList<PurchaseRequest> ListPurchaseRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT  *  FROM PurchaseRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END and PurchaseRequests.Requester='"
                + GetCurrentUser().Id
        ...
        public IList<PurchaseRequest> ListPurchaseRequestForBids(
            string RequestNo,
            string RequestDate,
        ...
        {
            string filterExpression =
                "SELECT  *  FROM InventoryRequests WHERE 1 = CASE WHEN '"
                + RequestNo
                ...
                + RequestDate
                + "'  THEN 1 END AND InventoryRequests.Requester='"
                + GetCurrentUser().Id
        ...
        public IList<SoleVendorRequest> ListSoleVendorRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT * FROM SoleVendorRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And SoleVendorRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        )
        {
            ...
            filterExpression =
                "SELECT * FROM BidAnalysisRequests Where 1 = Case when '"
                + RequestNo
                ...
                + RequestDate
                + "'  Then 1 END And BidAnalysisRequests.AppUser_Id='"
                + GetCurrentUser().Id
        ...
        public IList<FuelCardRequest> ListFuelCardRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT  *  FROM FuelCardRequests Where 1 = Case when '"
                + RequestNo
                + "' = '' Then 1 When FuelCardRequests.RequestNo = '"
                + RequestNo
                + "'  Then 1 END And  1 = Case when '"
                + RequestDate
                + "' = '' Then 1 When FuelCardRequests.RequestedDate = '"
                + RequestDate
                + "'  Then 1 END and PurchaseRequests.Requester='"
                + GetCurrentUser().Id
        ...
        public IList<CabRequest> ListCabRequests(string RequestNo, string RequestDate)
        {
            ...
            filterExpression =
                "SELECT * FROM CabRequests Where 1 = Case when '"
                + RequestNo
                + "' = '' Then 1 When CabRequests.CabNo = '"
                + RequestNo
                + "' Then 1 END And  1 = Case when '"
                + RequestDate
                + "' = '' Then 1 When CabRequests.RequestDate = '"
                + RequestDate
                + "'  Then 1 END And CabRequests.AppUser_Id='"
                + GetCurrentUser().Id
                + "' ORDER BY CabRequests.Id Desc ";
