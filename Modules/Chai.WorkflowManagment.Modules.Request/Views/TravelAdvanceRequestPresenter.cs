...
namespace Chai.WorkflowManagment.Modules.Request.Views
{
    public class TravelAdvanceRequestPresenter : Presenter<ITravelAdvanceRequestView>
    {
        ...
        private void SendEmail(TravelAdvanceRequestStatus VRS)
        {
            ...
            {
                EmailSender.Send(GetSuperviser(VRS.Approver).Email, "Travel Advance Request", CurrentTravelAdvanceRequest.AppUser.FullName + "' Request for Item Travel Advance No." + CurrentTravelAdvanceRequest.TravelAdvanceNo + "'");
            }
            else
            {
                EmailSender.Send(GetSuperviser(_controller.GetAssignedJobbycurrentuser(VRS.Approver).AssignedTo).Email, "Travel Advance Request", CurrentTravelAdvanceRequest.AppUser.FullName + "' Request for Item Travel Advance No." + CurrentTravelAdvanceRequest.TravelAdvanceNo + "'");
            }
        }
        public void Commit()
        {
